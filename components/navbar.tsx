  ...
  return (
    <nav className="flex items-center justify-between py-4 px-6 border-b bg-white sticky top-0 z-50">
      ...
      <div className="hidden md:flex items-center gap-6">
        ...
        <Button className="bg-yellow-500 hover:bg-yellow-600 text-white">Get Started</Button>
      </div>
        ...
        <Sheet>
          ...
          <SheetContent side="right" className="bg-white p-6">
            <div className="flex flex-col gap-6">
              <Link href="#features" className="text-gray-800 hover:text-gray-900">Features</Link>
              <Link href="#how-it-works" className="text-gray-800 hover:text-gray-900">How It Works</Link>
              <Link href="#industries" className="text-gray-800 hover:text-gray-900">Industries</Link>
